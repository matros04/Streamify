...
const ChatPage = () => {
  ...
  const {data: tokenData} = useQuery({
    ...
    enabled: !!authUser //this query will only run if auth user is available
  });
  ...
  useEffect(()=>{
    const initChat = async ()=>{
      ...
      try {
        console.log("initalize stream chat client");
        ...
        //therefore sort is necessary

        const currChannel = client.channel("messaging", channelId, {
          members:[authUser._id, targetUserId],
        });
        
        //loads the intital channel state and wait for changes
